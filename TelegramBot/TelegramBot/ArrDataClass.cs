namespace TelegramBot
{
    public class ArrDataClass
    {
        ...
        public static string[] WhatsUpArr = { "Как дела?", "как дела?", "как дела" };
        ...
        public static string[] WhatAreYouDoArr = { "Что делаешь?", "что делаешь?", "Что делаешь", "чд", "Чд", "Чем занимаешься?", "чем занимаешься?", "чем занимаешься" };
